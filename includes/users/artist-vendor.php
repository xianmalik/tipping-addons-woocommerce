        ...
        <div class="artist-registration-form">
            ...
            <form id="artist-registration-form" method="post">
                ...
                <p>
                    ...
                    <button type="submit" class="button"><?php _e('Register', 'tipping-addons-jetengine'); ?></button>
                </p>
            </form>
        </div>
        <?php
